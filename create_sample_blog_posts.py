...
def main():
    ...
    print(f"🌐 Visit: https://responsive-nav-3.preview.emergentagent.com/blog")
    print(f"⚙️  Admin Panel: https://responsive-nav-3.preview.emergentagent.com/admin/content")
