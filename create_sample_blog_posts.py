...
def main():
    ...
    print(f"🌐 Visit: https://grras-course-manager.preview.emergentagent.com/blog")
    print(f"⚙️  Admin Panel: https://grras-course-manager.preview.emergentagent.com/admin/content")
