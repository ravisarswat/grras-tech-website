...
def main():
    ...
    print(f"🌐 Visit: https://ecstatic-jackson.preview.emergentagent.com/blog")
    print(f"⚙️  Admin Panel: https://ecstatic-jackson.preview.emergentagent.com/admin/content")
