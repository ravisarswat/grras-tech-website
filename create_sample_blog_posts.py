...
BASE_URL = "https://grras-content-sync.preview.emergentagent.com/api"
...
def main():
    ...
    print(f"🌐 Visit: https://grras-content-sync.preview.emergentagent.com/blog")
    print(f"⚙️  Admin Panel: https://grras-content-sync.preview.emergentagent.com/admin/content")
