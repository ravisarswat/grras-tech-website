...
def main():
    ...
    print(f"🌐 Visit: https://edutech-platform.preview.emergentagent.com/blog")
    print(f"⚙️  Admin Panel: https://edutech-platform.preview.emergentagent.com/admin/content")
