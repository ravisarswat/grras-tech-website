...
def main():
    ...
    print(f"🌐 Visit: https://responsive-edu-site.preview.emergentagent.com/blog")
    print(f"⚙️  Admin Panel: https://responsive-edu-site.preview.emergentagent.com/admin/content")
