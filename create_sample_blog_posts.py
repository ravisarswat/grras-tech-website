...
BASE_URL = "https://grras-web-revamp.preview.emergentagent.com/api"
...
def main():
    ...
    print(f"🌐 Visit: https://grras-web-revamp.preview.emergentagent.com/blog")
    print(f"⚙️  Admin Panel: https://grras-web-revamp.preview.emergentagent.com/admin/content")
