...
const HeroSlider = () => {
  ...
  return (
    <section className="relative min-h-[450px] sm:min-h-[500px] md:min-h-[450px] lg:min-h-[420px] overflow-hidden flex items-center">
      ...
      {/* Content */}
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 md:py-8 lg:py-12 h-full flex items-center justify-center">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center justify-items-center w-full min-h-0">
          ...
          <div className="text-center lg:text-left animate-fade-in-up flex flex-col justify-center items-center lg:items-start self-center w-full">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl font-bold leading-tight mb-3 lg:mb-4 text-white drop-shadow-lg">
              {currentSlideData.title}
              <div className="text-lg sm:text-xl md:text-2xl lg:text-2xl xl:text-3xl font-semibold text-white/90 mt-2">
            ...
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start max-w-md mx-auto lg:max-w-none lg:mx-0 mt-2 mb-2 pb-16 sm:pb-2">
              <Link
