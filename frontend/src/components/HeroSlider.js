...
const HeroSlider = () => {
  ...
  return (
    <section className="relative min-h-[400px] sm:min-h-[450px] md:min-h-[400px] lg:min-h-[380px] overflow-hidden flex items-center">
      ...
      {/* Content */}
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 lg:py-16 h-full flex items-center justify-center">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center justify-items-center w-full">
          
          {/* Left Content */}
          <div className="text-center lg:text-left animate-fade-in-up flex flex-col justify-center items-center lg:items-start min-h-0">
            {/* Icon */}
            ...
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start max-w-md mx-auto lg:max-w-none lg:mx-0 pb-4 sm:pb-2">
              <Link
