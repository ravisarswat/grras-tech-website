...
const HeroSlider = () => {
  ...
  return (
    <section className="relative h-[500px] sm:h-[550px] md:h-[500px] lg:h-[480px] overflow-hidden flex items-center" style={{ contain: 'layout' }}>
      ...
      {/* Content */}
      <div 
        className="relative max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-8 lg:py-12 pb-16 sm:pb-20 lg:pb-24 h-full flex items-center justify-center"
      ...
      >
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center justify-items-center w-full min-h-0">
          ...
          <div className="text-center lg:text-left animate-fade-in-up flex flex-col justify-center items-center lg:items-start self-center w-full max-w-2xl mx-auto lg:mx-0">
            ...
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start max-w-md mx-auto lg:max-w-none lg:mx-0 mt-2 pb-4 sm:pb-2">
              <Link
