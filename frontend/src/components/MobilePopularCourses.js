    ...
    <section className="py-8 bg-gradient-to-b from-white to-gray-50 lg:hidden">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-6">
          <div className="inline-flex items-center bg-gradient-to-r from-blue-500 to-purple-500 text-white px-4 py-2 rounded-full text-sm font-semibold mb-3 shadow-lg">
          ...
          <p className="text-gray-600 text-sm">
            Job-ready courses with 95% placement success
          </p>
        </div>
